...
/**
 * This is the model class for table "SalaryDetails".
 *
 * The followings are the available columns in table 'SalaryDetails':
 * @property integer $id
...
class SalaryDetails extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('officerId, type, isRecevingSalary, salaryRecevingPlace, salaryStartDate, salaryEndDate, basic, bonus, totalSalary, salaryReceivingBy, isRecevingPension, pensionNo, pensionRecevingPlace, pensionAmount, pensionReceivingBy, pensionStartDate, isRecevingDisabledPension, disabledPensionStartDate, totalDisabledPensionAmount, disabledPensionReceivingPlace, disabledPensionEndDate, isRecevingBonus, bonusStartDate, bonusEndDate, bonusTotalAmount, bonusRecevingPlace', 'required'),
			array('officerId, pensionReceivingBy', 'numerical', 'integerOnly'=>true),
			...
			array('id, officerId, type, isRecevingSalary, salaryRecevingPlace, salaryStartDate, salaryEndDate, basic, bonus, totalSalary, salaryReceivingBy, isRecevingPension, pensionNo, pensionRecevingPlace, pensionAmount, pensionReceivingBy, pensionStartDate, isRecevingDisabledPension, disabledPensionStartDate, totalDisabledPensionAmount, disabledPensionReceivingPlace, disabledPensionEndDate, isRecevingBonus, bonusStartDate, bonusEndDate, bonusTotalAmount, bonusRecevingPlace, createdAt, updatedAt', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function afterSave()
    {
        ...
        $History = new SalaryDetailsHistory();
