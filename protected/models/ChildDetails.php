...
/**
 * This is the model class for table "ChildDetails".
 *
 * The followings are the available columns in table 'ChildDetails':
 * @property integer $id
 ...
 */
class ChildDetails extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('officerId, type, fullName, otherName, initials, NIC, DOB, gender, isSchooling, school, grade, isWorking, designation, workplaceAddress, healthCondition', 'required'),
			...
			array('id, officerId, type, fullName, otherName, initials, NIC, DOB, gender, isSchooling, school, grade, isWorking, designation, workplaceAddress, healthCondition, createdAt, updatedAt', 'safe', 'on'=>'search'),
		);
	}
...
return array(
	 ...
	 * @return ChildDetails the static model class
	 */
