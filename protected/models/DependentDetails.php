...
/**
 * This is the model class for table "DependentDetails".
 *
 * The followings are the available columns in table 'DependentDetails':
 * @property integer $id
 ...
 */
class DependentDetails extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('officerId, type, NIC, fullName, otherName, initials, DOB, gender, nationality, religion, currentAddress, currentAddPoliceDivision, isSchooling, school, grade, isWorking, designation, workplaceAddress, healthCondition', 'required'),
			...
			array('id, officerId, type, NIC, fullName, otherName, initials, DOB, gender, nationality, religion, currentAddress, currentAddPoliceDivision, isSchooling, school, grade, isWorking, designation, workplaceAddress, healthCondition, createdAt, updatedAt', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function afterSave()
    {
        ...
        $History = new DependentDetailsHistory();
...
return array(
	 ...
	 * @return DependentDetails the static model class
	 */
