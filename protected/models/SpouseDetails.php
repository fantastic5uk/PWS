...
/**
 * This is the model class for table "SpouseDetails".
 *
 * The followings are the available columns in table 'SpouseDetails':
 * @property integer $id
 ...
 */
class SpouseDetails extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, officerId, type, NIC, fullName, otherName, initials, relationship, DOB, nationality, religion, gender, currentAddress, currentAddPoliceDivision, currentTelNo, JPdivison, divisionalSecOffice, operationalDistrtict, permanantAddress, permanantTelNo, permanantAddPoliceDivision, isMarriedAgain, marriedDate, isReceivingPension50, isWorking, designation, workplaceAddress, healthCondition, createdAt, updatedAt', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function afterSave()
    {
        ...
        $History = new SpouseDetailsHistory();
...
return array(
	 ...
	 * @return SpouseDetails the static model class
	 */
